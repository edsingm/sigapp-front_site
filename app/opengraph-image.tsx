...
export const alt =
  "SIGAPP — Plataforma de Viabilidade e Gestão Imobiliária"
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            <path d="M42 146c162-62 340-62 508 6 168 68 354 90 608 12" stroke="rgba(255,255,255,0.16)" strokeWidth="2" strokeDasharray="6 14" />
            <path d="M24 258c184-56 366-34 550 34 164 60 348 78 590 20" stroke="rgba(255,255,255,0.12)" strokeWidth="2" strokeDasharray="6 14" />
            <path d="M58 394c172-44 356-20 530 32 162 48 340 54 548 6" stroke="rgba(255,255,255,0.12)" strokeWidth="2" strokeDasharray="6 14" />
            <path d="M160 110 298 84 412 126 388 222 226 234 130 178Z" fill="rgba(255,255,255,0.05)" stroke="rgba(255,255,255,0.2)" />
        ...
        >
          <span style={{ fontSize: 28, color: "rgba(255,255,255,0.82)" }}>
            Plataforma de viabilidade e gestão imobiliária
          </span>
          <span
            style={{
              display: "flex",
